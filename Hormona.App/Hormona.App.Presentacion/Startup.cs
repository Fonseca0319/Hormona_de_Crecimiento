...
namespace Hormona.App.Presentacion
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IRepositorioPediatraMemoria,RepositorioPediatraMemoria>();
             ...
             services.AddScoped<IRepositorioEndocrino,RepositorioEndocrino>();
             services.AddScoped<IRepositorioPediatra,RepositorioPediatra>();
            ...
            services.AddDbContext<Persistencia.AppContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("HormonaDeCreciminentoContext")));
